    ...
    <Container>
      ...
      <hr className="customHr"></hr>
        ...
        {/* <Row className="project1Row d-flex align-items-center">
          ...
          <Col md={6} className="project1Col projectsCol">
            <p className="featuredProject">Featured Project</p>
            <p className="projectTitle">MERN Food Tracker</p>
            <div className="project1Desc projectDesc">
              <p>Web-based application built using the MERN stack that allows users to create, read, update, and delete food items along with tracking the days since they last ate each food item.</p>
            </div>
        ...
        <Row className="project1Row d-flex align-items-center">
            {/* PROJECT 3: */}
          <Col md={6}>
            <img className="project1Img projectImg" src={project3Img} alt="Project 3"></img>
          </Col>
          <Col md={6} className="project1Col projectsCol">
            <p className="featuredProject">Featured Project</p>
            <p className="projectTitle">WeatherCenter</p>
            <div className="project1Desc projectDesc">
              <p>Weather Center is a web application that allows users to search for weather information for a specific location. Users can view current weather conditions, as well as a 5-day forecast, for any desired location. The application retrieves weather data from a third-party API.</p>
            </div>
