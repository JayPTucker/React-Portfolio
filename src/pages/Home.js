          ...
          <Row>
            <Col md={4}>
              <Card className="projectCard">
                <Card.Body>
                  <Card.Title>
                  <span className="projectTitle">Project Title
                    <a className="info-panel-icons" href="" target="_blank" rel="noopener noreferrer">
                  ...
                  <Card.Text>
                    ...
                    the card's content.
                    <br></br>
                    <p className="skillsUsed">Languages Used</p>
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
